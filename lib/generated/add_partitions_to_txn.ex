...
"
  ...
  (
    ...
    @type request_t ::
            Kayrock.AddPartitionsToTxn.V1.Request.t() | Kayrock.AddPartitionsToTxn.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.AddPartitionsToTxn.V1.Response.t()
            | Kayrock.AddPartitionsToTxn.V0.Response.t()
  )
