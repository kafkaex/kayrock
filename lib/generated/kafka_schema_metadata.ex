defmodule Kayrock.KafkaSchemaMetadata do
  ...
  def version_range(:offset_for_leader_epoch) do
    {0, 3}
  end
  ...
  def version_range(:elect_leaders) do
    {0, 2}
  end

  def version_range(:incremental_alter_configs) do
    {0, 1}
  end

  def version_range(:alter_partition_reassignments) do
    {0, 0}
  end

  def version_range(:list_partition_reassignments) do
    {0, 0}
  end

  def version_range(:offset_delete) do
    {0, 0}
  end
  ...
  (
    def api_key(:offset_for_leader_epoch) do
      23
    end
  ...
  (
    def api_key(:incremental_alter_configs) do
      44
    end
  ...
  (
    def api_key(:alter_partition_reassignments) do
      45
    end
  ...
  (
    def api_key(:list_partition_reassignments) do
      46
    end
  ...
  def request_schema(:produce, 6) do
    [
      transactional_id: :nullable_string,
      acks: :int16,
      timeout: :int32,
  ...
  def request_schema(:produce, 7) do
    [
      transactional_id: :nullable_string,
      acks: :int16,
      timeout: :int32,
  ...
  def request_schema(:produce, 8) do
    [
      transactional_id: :nullable_string,
      acks: :int16,
      timeout: :int32,
  ...
  def request_schema(:fetch, 10) do
    [
      replica_id: :int32,
      max_wait_time: :int32,
      min_bytes: :int32,
  ...
  def request_schema(:fetch, 11) do
    [
      replica_id: :int32,
      max_wait_time: :int32,
      min_bytes: :int32,
  ...
  def request_schema(:list_offsets, 1) do
    [
      replica_id: :int32,
      topics: {:array, topic: :string, partitions: {:array, partition: :int32, timestamp: :int64}}
    ]
  end
  ...
  def request_schema(:list_offsets, 3) do
    [
      replica_id: :int32,
      isolation_level: :int8,
      topics: {:array, topic: :string, partitions: {:array, partition: :int32, timestamp: :int64}}
  ...
  def request_schema(:list_offsets, 4) do
    [
      replica_id: :int32,
      isolation_level: :int8,
      topics:
        {:array,
         topic: :string,
         partitions: {:array, partition: :int32, current_leader_epoch: :int32, timestamp: :int64}}
    ]
  end

  def request_schema(:list_offsets, 5) do
    [
      replica_id: :int32,
      isolation_level: :int8,
      topics:
  ...
  def request_schema(:metadata, 6) do
    [topics: {:array, name: :string}, allow_auto_topic_creation: :boolean]
  end

  def request_schema(:metadata, 7) do
    [topics: {:array, name: :string}, allow_auto_topic_creation: :boolean]
  end

  def request_schema(:metadata, 8) do
    [
      topics: {:array, name: :string},
  ...
  def request_schema(:metadata, 9) do
    [
  ...
  def request_schema(:offset_commit, 4) do
    [
      group_id: :string,
      generation_id: :int32,
      member_id: :string,
  ...
  def request_schema(:offset_commit, 5) do
    [
      group_id: :string,
      generation_id: :int32,
      member_id: :string,
  ...
  def request_schema(:offset_commit, 6) do
    [
      group_id: :string,
      generation_id: :int32,
      member_id: :string,
  ...
  def request_schema(:offset_commit, 7) do
    [
      group_id: :string,
      generation_id: :int32,
      member_id: :string,
  ...
  def request_schema(:offset_commit, 8) do
    [
  ...
  def request_schema(:offset_fetch, 4) do
    [group_id: :string, topics: {:array, name: :string, partition_indexes: {:array, :int32}}]
  end

  def request_schema(:offset_fetch, 5) do
    [group_id: :string, topics: {:array, name: :string, partition_indexes: {:array, :int32}}]
  end

  def request_schema(:offset_fetch, 6) do
    [
      group_id: :compact_string,
      topics:
        {:compact_array,
  ...
  def request_schema(:find_coordinator, 2) do
    [key: :string, key_type: :int8]
  end

  def request_schema(:find_coordinator, 3) do
  ...
  def request_schema(:join_group, 3) do
    [
      group_id: :string,
      session_timeout_ms: :int32,
      rebalance_timeout_ms: :int32,
  ...
  def request_schema(:join_group, 4) do
    [
      group_id: :string,
      session_timeout_ms: :int32,
      rebalance_timeout_ms: :int32,
  ...
  def request_schema(:join_group, 5) do
    [
      group_id: :string,
      session_timeout_ms: :int32,
      rebalance_timeout_ms: :int32,
  ...
  def request_schema(:join_group, 6) do
    [
      group_id: :compact_string,
      session_timeout_ms: :int32,
      rebalance_timeout_ms: :int32,
      ...
      protocols:
        {:compact_array,
         name: :compact_string, metadata: :compact_bytes, tagged_fields: :tagged_fields},
      tagged_fields: :tagged_fields
    ]
  end
  ...
  def request_schema(:heartbeat, 2) do
    [group_id: :string, generation_id: :int32, member_id: :string]
  end

  def request_schema(:heartbeat, 3) do
    [
      group_id: :string,
      generation_id: :int32,
      member_id: :string,
  ...
  def request_schema(:heartbeat, 4) do
    [
      group_id: :compact_string,
      generation_id: :int32,
      member_id: :compact_string,
  ...
  def request_schema(:leave_group, 2) do
    [group_id: :string, member_id: :string]
  end

  def request_schema(:leave_group, 3) do
    [
      group_id: :string,
  ...
  def request_schema(:leave_group, 4) do
    [
      group_id: :compact_string,
      members:
        {:compact_array,
  ...
  def request_schema(:sync_group, 2) do
    [
      group_id: :string,
      generation_id: :int32,
      member_id: :string,
  ...
  def request_schema(:sync_group, 3) do
    [
      group_id: :string,
      generation_id: :int32,
      member_id: :string,
  ...
  def request_schema(:sync_group, 4) do
    [
      group_id: :compact_string,
      generation_id: :int32,
      member_id: :compact_string,
  ...
  def request_schema(:describe_groups, 2) do
    [groups: {:array, :string}]
  end

  def request_schema(:describe_groups, 3) do
    [groups: {:array, :string}, include_authorized_operations: :boolean]
  end

  def request_schema(:describe_groups, 4) do
    [groups: {:array, :string}, include_authorized_operations: :boolean]
  end

  def request_schema(:describe_groups, 5) do
    [
  ...
  def request_schema(:list_groups, 2) do
    []
  end

  def request_schema(:list_groups, 3) do
    [tagged_fields: :tagged_fields]
  end
  ...
  def request_schema(:api_versions, 2) do
    []
  end

  def request_schema(:api_versions, 3) do
    [
  ...
  def request_schema(:create_topics, 3) do
    [
      topics:
        {:array,
         name: :string,
  ...
  def request_schema(:create_topics, 4) do
    [
      topics:
        {:array,
         name: :string,
  ...
  def request_schema(:create_topics, 5) do
    [
      topics:
        {:compact_array,
         name: :compact_string,
         ...
         configs:
           {:compact_array,
            name: :compact_string, value: :compact_nullable_string, tagged_fields: :tagged_fields},
         tagged_fields: :tagged_fields},
      timeout_ms: :int32,
      validate_only: :boolean,
      tagged_fields: :tagged_fields
  ...
  def request_schema(:delete_topics, 2) do
    [topic_names: {:array, :string}, timeout_ms: :int32]
  end

  def request_schema(:delete_topics, 3) do
    [topic_names: {:array, :string}, timeout_ms: :int32]
  end

  def request_schema(:delete_topics, 4) do
    [
  ...
  def request_schema(:delete_records, 1) do
    [
      topics: {:array, topic: :string, partitions: {:array, partition: :int32, offset: :int64}},
      timeout: :int32
    ]
  ...
  def request_schema(:init_producer_id, 1) do
    [transactional_id: :nullable_string, transaction_timeout_ms: :int32]
  end

  def request_schema(:init_producer_id, 2) do
    [
  ...
  def request_schema(:offset_for_leader_epoch, 0) do
    [
      topics:
        {:array, topic: :string, partitions: {:array, partition: :int32, leader_epoch: :int32}}
    ]
  end

  def request_schema(:offset_for_leader_epoch, 1) do
    [
      topics:
        {:array, topic: :string, partitions: {:array, partition: :int32, leader_epoch: :int32}}
    ]
  ...
  def request_schema(:offset_for_leader_epoch, 2) do
    [
      topics:
        {:array,
         topic: :string,
  ...
  def request_schema(:offset_for_leader_epoch, 3) do
    [
      replica_id: :int32,
      topics:
        {:array,
  ...
  def request_schema(:add_partitions_to_txn, 1) do
    [
      transactional_id: :string,
      producer_id: :int64,
      producer_epoch: :int16,
  ...
  def request_schema(:add_offsets_to_txn, 1) do
    [transactional_id: :string, producer_id: :int64, producer_epoch: :int16, group_id: :string]
  end
  ...
  def request_schema(:end_txn, 1) do
    [
      transactional_id: :string,
      producer_id: :int64,
      producer_epoch: :int16,
  ...
  def request_schema(:txn_offset_commit, 1) do
    [
      transactional_id: :string,
      group_id: :string,
      producer_id: :int64,
  ...
  def request_schema(:txn_offset_commit, 2) do
    [
      transactional_id: :string,
      group_id: :string,
      producer_id: :int64,
  ...
  def request_schema(:describe_acls, 1) do
    [
      resource_type: :int8,
      resource_name: :nullable_string,
  ...
  def request_schema(:create_acls, 1) do
    [
      creations:
        {:array,
         resource_type: :int8,
  ...
  def request_schema(:delete_acls, 1) do
    [
      filters:
        {:array,
         resource_type: :int8,
  ...
  def request_schema(:describe_configs, 2) do
    [
      resources:
        {:array, resource_type: :int8, resource_name: :string, config_names: {:array, :string}},
      include_synonyms: :boolean
  ...
  def request_schema(:alter_configs, 1) do
    [
      resources:
        {:array,
         resource_type: :int8,
  ...
  def request_schema(:alter_replica_log_dirs, 0) do
    [
      log_dirs:
        {:array, log_dir: :string, topics: {:array, topic: :string, partitions: {:array, :int32}}}
    ]
  end

  def request_schema(:alter_replica_log_dirs, 1) do
    [
      log_dirs:
        {:array, log_dir: :string, topics: {:array, topic: :string, partitions: {:array, :int32}}}
    ]
  ...
  def request_schema(:describe_log_dirs, 1) do
    [topics: {:array, topic: :string, partitions: {:array, :int32}}]
  end
  ...
  def request_schema(:sasl_authenticate, 1) do
    [auth_bytes: :bytes]
  end
  ...
  def request_schema(:create_partitions, 1) do
    [
      topic_partitions:
        {:array,
         topic: :string, new_partitions: [count: :int32, assignment: {:array, {:array, :int32}}]},
  ...
  def request_schema(:create_delegation_token, 1) do
    [
      renewers: {:array, principal_type: :string, principal_name: :string},
      max_lifetime_ms: :int64
    ]
  ...
  def request_schema(:create_delegation_token, 2) do
    [
      renewers:
        {:compact_array,
  ...
  def request_schema(:renew_delegation_token, 1) do
    [hmac: :bytes, renew_period_ms: :int64]
  end
  ...
  def request_schema(:expire_delegation_token, 1) do
    [hmac: :bytes, expiry_time_period_ms: :int64]
  end
  ...
  def request_schema(:describe_delegation_token, 1) do
    [owners: {:array, principal_type: :string, principal_name: :string}]
  end
  ...
  def request_schema(:delete_groups, 1) do
    [groups_names: {:array, :string}]
  end

  def request_schema(:delete_groups, 2) do
    [groups_names: {:compact_array, :compact_string}, tagged_fields: :tagged_fields]
  end

  def request_schema(:elect_leaders, 0) do
    [
  ...
  def request_schema(:elect_leaders, 1) do
    [
      election_type: :int8,
      topic_partitions: {:array, topic: :string, partition_id: {:array, :int32}},
      timeout_ms: :int32
  ...
  def request_schema(:elect_leaders, 2) do
    [
      election_type: :int8,
      topic_partitions:
        {:compact_array,
  ...
  def request_schema(:incremental_alter_configs, 0) do
    [
      resources:
        {:array,
         resource_type: :int8,
         resource_name: :string,
         configs: {:array, name: :string, config_operation: :int8, value: :nullable_string}},
      validate_only: :boolean
    ]
  end

  def request_schema(:incremental_alter_configs, 1) do
    [
      resources:
        {:compact_array,
         resource_type: :int8,
  ...
  def request_schema(:alter_partition_reassignments, 0) do
    [
      timeout_ms: :int32,
      topics:
        {:compact_array,
  ...
  def request_schema(:list_partition_reassignments, 0) do
    [
      timeout_ms: :int32,
      topics:
        {:compact_array,
  ...
  def request_schema(:offset_delete, 0) do
    [
      group_id: :string,
  ...
  def response_schema(:produce, 0) do
    [
      responses:
        {:array,
         topic: :string,
         partition_responses: {:array, partition: :int32, error_code: :int16, base_offset: :int64}}
    ]
  end
    ...
    [
      responses:
        {:array,
         ...
         partition_responses:
           {:array,
            partition: :int32, error_code: :int16, base_offset: :int64, log_append_time: :int64}},
      throttle_time_ms: :int32
    ]
  end
  ...
  def response_schema(:produce, 6) do
    [
      responses:
        {:array,
         topic: :string,
  ...
  def response_schema(:produce, 7) do
    [
      responses:
        {:array,
         topic: :string,
  ...
  def response_schema(:produce, 8) do
    [
      responses:
        {:array,
         topic: :string,
         partition_responses:
           {:array,
            ...
            log_start_offset: :int64,
            record_errors:
              {:array, batch_index: :int32, batch_index_error_message: :nullable_string},
  ...
  def response_schema(:fetch, 8) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      session_id: :int32,
  ...
  def response_schema(:fetch, 9) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      session_id: :int32,
  ...
  def response_schema(:fetch, 10) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      session_id: :int32,
  ...
  def response_schema(:fetch, 11) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      session_id: :int32,
  ...
  def response_schema(:list_offsets, 3) do
    [
      throttle_time_ms: :int32,
      responses:
        {:array,
  ...
  def response_schema(:list_offsets, 4) do
    [
      throttle_time_ms: :int32,
      responses:
        {:array,
  ...
  def response_schema(:list_offsets, 5) do
    [
      throttle_time_ms: :int32,
      responses:
        {:array,
  ...
  def response_schema(:metadata, 6) do
    [
      throttle_time_ms: :int32,
      brokers: {:array, node_id: :int32, host: :string, port: :int32, rack: :nullable_string},
      cluster_id: :nullable_string,
  ...
  def response_schema(:metadata, 7) do
    [
      throttle_time_ms: :int32,
      brokers: {:array, node_id: :int32, host: :string, port: :int32, rack: :nullable_string},
      cluster_id: :nullable_string,
  ...
  def response_schema(:metadata, 8) do
    [
      throttle_time_ms: :int32,
      brokers: {:array, node_id: :int32, host: :string, port: :int32, rack: :nullable_string},
      cluster_id: :nullable_string,
  ...
  def response_schema(:metadata, 9) do
    [
      throttle_time_ms: :int32,
      brokers:
        {:compact_array,
  ...
  def response_schema(:offset_commit, 0) do
    [
      topics:
        {:array, name: :string, partitions: {:array, partition_index: :int32, error_code: :int16}}
    ]
  end
  ...
  def response_schema(:offset_commit, 4) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array, name: :string, partitions: {:array, partition_index: :int32, error_code: :int16}}
  ...
  def response_schema(:offset_commit, 5) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array, name: :string, partitions: {:array, partition_index: :int32, error_code: :int16}}
  ...
  def response_schema(:offset_commit, 6) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array, name: :string, partitions: {:array, partition_index: :int32, error_code: :int16}}
  ...
  def response_schema(:offset_commit, 7) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array, name: :string, partitions: {:array, partition_index: :int32, error_code: :int16}}
  ...
  def response_schema(:offset_commit, 8) do
    [
      throttle_time_ms: :int32,
      topics:
        {:compact_array,
  ...
  def response_schema(:offset_fetch, 4) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array,
  ...
  def response_schema(:offset_fetch, 5) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array,
  ...
  def response_schema(:offset_fetch, 6) do
    [
      throttle_time_ms: :int32,
      topics:
        {:compact_array,
  ...
  def response_schema(:find_coordinator, 2) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      error_message: :nullable_string,
  ...
  def response_schema(:find_coordinator, 3) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
  ...
  def response_schema(:join_group, 3) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      generation_id: :int32,
  ...
  def response_schema(:join_group, 4) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      generation_id: :int32,
  ...
  def response_schema(:join_group, 5) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      generation_id: :int32,
      ...
      leader: :string,
      member_id: :string,
      members: {:array, member_id: :string, group_instance_id: :nullable_string, metadata: :bytes}
    ]
  end

  def response_schema(:join_group, 6) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      generation_id: :int32,
  ...
  def response_schema(:heartbeat, 2) do
    [throttle_time_ms: :int32, error_code: :int16]
  end

  def response_schema(:heartbeat, 3) do
    [throttle_time_ms: :int32, error_code: :int16]
  end

  def response_schema(:heartbeat, 4) do
  ...
  def response_schema(:leave_group, 2) do
    [throttle_time_ms: :int32, error_code: :int16]
  end

  def response_schema(:leave_group, 3) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      members:
  ...
  def response_schema(:leave_group, 4) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      members:
  ...
  def response_schema(:sync_group, 2) do
    [throttle_time_ms: :int32, error_code: :int16, assignment: :bytes]
  end

  def response_schema(:sync_group, 3) do
    [throttle_time_ms: :int32, error_code: :int16, assignment: :bytes]
  end

  def response_schema(:sync_group, 4) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
  ...
  def response_schema(:describe_groups, 2) do
    [
      throttle_time_ms: :int32,
      groups:
        {:array,
  ...
  def response_schema(:describe_groups, 3) do
    [
      throttle_time_ms: :int32,
      groups:
        {:array,
  ...
  def response_schema(:describe_groups, 4) do
    [
      throttle_time_ms: :int32,
      groups:
        {:array,
  ...
  def response_schema(:describe_groups, 5) do
    [
      throttle_time_ms: :int32,
      groups:
        {:compact_array,
  ...
  def response_schema(:list_groups, 2) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      groups: {:array, group_id: :string, protocol_type: :string}
  ...
  def response_schema(:list_groups, 3) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      groups:
        {:compact_array,
         group_id: :compact_string, protocol_type: :compact_string, tagged_fields: :tagged_fields},
      tagged_fields: :tagged_fields
    ]
  end
  ...
  def response_schema(:api_versions, 2) do
    [
      error_code: :int16,
      api_keys: {:array, api_key: :int16, min_version: :int16, max_version: :int16},
      throttle_time_ms: :int32
  ...
  def response_schema(:api_versions, 3) do
    [
      error_code: :int16,
      api_keys:
        {:compact_array,
         api_key: :int16, min_version: :int16, max_version: :int16, tagged_fields: :tagged_fields},
      throttle_time_ms: :int32,
      tagged_fields: :tagged_fields
    ]
  end
  ...
  def response_schema(:create_topics, 3) do
    [
      throttle_time_ms: :int32,
      topics: {:array, name: :string, error_code: :int16, error_message: :nullable_string}
    ]
  ...
  def response_schema(:create_topics, 4) do
    [
      throttle_time_ms: :int32,
      topics: {:array, name: :string, error_code: :int16, error_message: :nullable_string}
    ]
  ...
  def response_schema(:create_topics, 5) do
    [
      throttle_time_ms: :int32,
      topics:
        {:compact_array,
  ...
  def response_schema(:delete_topics, 1) do
    [throttle_time_ms: :int32, responses: {:array, name: :string, error_code: :int16}]
  end

  def response_schema(:delete_topics, 2) do
    [throttle_time_ms: :int32, responses: {:array, name: :string, error_code: :int16}]
  end

  def response_schema(:delete_topics, 3) do
    [throttle_time_ms: :int32, responses: {:array, name: :string, error_code: :int16}]
  end

  def response_schema(:delete_topics, 4) do
    [
      throttle_time_ms: :int32,
      responses:
        {:compact_array, name: :compact_string, error_code: :int16, tagged_fields: :tagged_fields},
      tagged_fields: :tagged_fields
    ]
  end
  ...
  def response_schema(:delete_records, 1) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array,
  ...
  def response_schema(:init_producer_id, 1) do
    [throttle_time_ms: :int32, error_code: :int16, producer_id: :int64, producer_epoch: :int16]
  end

  def response_schema(:init_producer_id, 2) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      producer_id: :int64,
  ...
  def response_schema(:offset_for_leader_epoch, 0) do
    [
      topics:
        {:array,
         topic: :string,
  ...
  def response_schema(:offset_for_leader_epoch, 1) do
    [
      topics:
        {:array,
         topic: :string,
  ...
  def response_schema(:offset_for_leader_epoch, 2) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array,
  ...
  def response_schema(:offset_for_leader_epoch, 3) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array,
  ...
  def response_schema(:add_partitions_to_txn, 1) do
    [
      throttle_time_ms: :int32,
      errors:
        {:array,
  ...
  def response_schema(:add_offsets_to_txn, 1) do
    [throttle_time_ms: :int32, error_code: :int16]
  end
  ...
  def response_schema(:end_txn, 1) do
    [throttle_time_ms: :int32, error_code: :int16]
  end
  ...
  def response_schema(:txn_offset_commit, 1) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array, name: :string, partitions: {:array, partition_index: :int32, error_code: :int16}}
  ...
  def response_schema(:txn_offset_commit, 2) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array, name: :string, partitions: {:array, partition_index: :int32, error_code: :int16}}
    ...
    [
      ...
      resources:
        {:array,
         ...
         resource_name: :string,
         acls:
           {:array, principal: :string, host: :string, operation: :int8, permission_type: :int8}}
    ]
  end

  def response_schema(:describe_acls, 1) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      error_message: :nullable_string,
  ...
  def response_schema(:create_acls, 1) do
    [
      throttle_time_ms: :int32,
      creation_responses: {:array, error_code: :int16, error_message: :nullable_string}
    ]
  ...
  def response_schema(:delete_acls, 1) do
    [
      throttle_time_ms: :int32,
      filter_responses:
        {:array,
        ...
        {:array,
         ...
         config_entries:
           {:array,
            ...
            is_sensitive: :boolean,
            config_synonyms:
              {:array, config_name: :string, config_value: :nullable_string, config_source: :int8}}}
    ]
  end

  def response_schema(:describe_configs, 2) do
    [
      throttle_time_ms: :int32,
      resources:
        {:array,
  ...
  def response_schema(:alter_configs, 1) do
    [
      throttle_time_ms: :int32,
      resources:
        {:array,
  ...
  def response_schema(:alter_replica_log_dirs, 1) do
    [
      throttle_time_ms: :int32,
      topics:
        {:array, topic: :string, partitions: {:array, partition: :int32, error_code: :int16}}
        ...
        {:array,
         ...
         topics:
           {:array,
            topic: :string,
            partitions:
              {:array, partition: :int32, size: :int64, offset_lag: :int64, is_future: :boolean}}}
    ]
  end

  def response_schema(:describe_log_dirs, 1) do
    [
      throttle_time_ms: :int32,
      log_dirs:
        {:array,
  ...
  def response_schema(:sasl_authenticate, 1) do
    [
      error_code: :int16,
      error_message: :nullable_string,
      auth_bytes: :bytes,
  ...
  def response_schema(:create_partitions, 0) do
    [
      throttle_time_ms: :int32,
      topic_errors: {:array, topic: :string, error_code: :int16, error_message: :nullable_string}
    ]
  end

  def response_schema(:create_partitions, 1) do
    [
      throttle_time_ms: :int32,
      topic_errors: {:array, topic: :string, error_code: :int16, error_message: :nullable_string}
    ]
  ...
  def response_schema(:create_delegation_token, 1) do
    [
      error_code: :int16,
      principal_type: :string,
      principal_name: :string,
  ...
  def response_schema(:create_delegation_token, 2) do
    [
      error_code: :int16,
      principal_type: :compact_string,
      principal_name: :compact_string,
  ...
  def response_schema(:renew_delegation_token, 1) do
    [error_code: :int16, expiry_timestamp_ms: :int64, throttle_time_ms: :int32]
  end
  ...
  def response_schema(:expire_delegation_token, 1) do
    [error_code: :int16, expiry_timestamp_ms: :int64, throttle_time_ms: :int32]
  end
  ...
  def response_schema(:describe_delegation_token, 1) do
    [
      error_code: :int16,
      tokens:
        {:array,
  ...
  def response_schema(:delete_groups, 1) do
    [throttle_time_ms: :int32, results: {:array, group_id: :string, error_code: :int16}]
  end

  def response_schema(:delete_groups, 2) do
    [
      throttle_time_ms: :int32,
      results:
        {:compact_array,
  ...
  def response_schema(:elect_leaders, 0) do
    [
      throttle_time_ms: :int32,
  ...
  def response_schema(:elect_leaders, 1) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      replica_election_results:
  ...
  def response_schema(:elect_leaders, 2) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      replica_election_results:
  ...
  def response_schema(:incremental_alter_configs, 0) do
    [
      throttle_time_ms: :int32,
      responses:
        {:array,
  ...
  def response_schema(:incremental_alter_configs, 1) do
    [
      throttle_time_ms: :int32,
      responses:
        {:compact_array,
  ...
  def response_schema(:alter_partition_reassignments, 0) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      error_message: :compact_nullable_string,
  ...
  def response_schema(:list_partition_reassignments, 0) do
    [
      throttle_time_ms: :int32,
      error_code: :int16,
      error_message: :compact_nullable_string,
  ...
  def response_schema(:offset_delete, 0) do
    [
      error_code: :int16,
      throttle_time_ms: :int32,
      topics:
