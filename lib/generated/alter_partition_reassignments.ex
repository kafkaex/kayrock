defmodule Kayrock.AlterPartitionReassignments do
  @api :alter_partition_reassignments
...
"
    ...
    def api_key do
      Kayrock.KafkaSchemaMetadata.api_key(:alter_partition_reassignments)
    end
...
"
    ...
    defp deserialize_field(:root, :error_message, acc, data) do
      ...
      deserialize_field(:root, :responses, Map.put(acc, :error_message, val), rest)
    end

    defp deserialize_field(:responses, :name, acc, data) do
      {val, rest} = deserialize(:compact_string, data)
      deserialize_field(:responses, :partitions, Map.put(acc, :name, val), rest)
    end
    ...
    defp deserialize_field(:partitions, :error_code, acc, data) do
      {val, rest} = deserialize(:int16, data)
      deserialize_field(:partitions, :error_message, Map.put(acc, :error_code, val), rest)
    end

    defp deserialize_field(:partitions, :error_message, acc, data) do
      {val, rest} = deserialize(:compact_nullable_string, data)
      deserialize_field(:partitions, :tagged_fields, Map.put(acc, :error_message, val), rest)
    end
    ...
    defp deserialize_field(:responses, :partitions, acc, data) do
      ...
      deserialize_field(:responses, :tagged_fields, Map.put(acc, :partitions, final_vals), rest)
    end
  ...
  (
    ...
    @type request_t :: Kayrock.AlterPartitionReassignments.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t :: Kayrock.AlterPartitionReassignments.V0.Response.t()
  )
