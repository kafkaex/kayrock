    ...
    @schema replica_id: :int32,
            ...
            topics:
              {:array,
               topic: :string,
               partitions:
                 {:array, partition: :int32, current_leader_epoch: :int32, timestamp: :int64}}
    @moduledoc "Kayrock-generated request struct for Kafka `#{@api}` v#{@vsn} API
messages
...
"
    ...
    defp deserialize_field(:partition_responses, :offset, acc, data) do
      {val, rest} = deserialize(:int64, data)
      deserialize_field(:partition_responses, :leader_epoch, Map.put(acc, :offset, val), rest)
    end

    defp deserialize_field(:partition_responses, :leader_epoch, acc, data) do
      {val, rest} = deserialize(:int32, data)
      deserialize_field(:partition_responses, nil, Map.put(acc, :leader_epoch, val), rest)
    end
...
"
  ...
  (
    ...
    @type request_t ::
            Kayrock.ListOffsets.V5.Request.t()
            | Kayrock.ListOffsets.V4.Request.t()
            | Kayrock.ListOffsets.V3.Request.t()
  ...
  (
    ...
    @type response_t ::
            Kayrock.ListOffsets.V5.Response.t()
            | Kayrock.ListOffsets.V4.Response.t()
            | Kayrock.ListOffsets.V3.Response.t()
