                        ...
                        [
                          ...
                          for v <- vals do
                            [
                              ...
                              serialize(:int32, Map.fetch!(v, :partition_max_bytes))
                            ]
                          end
                        ]
                    end
    ...
    def serialize(%V7.Request{} = struct) do
      [
        ...
        [
          ...
          serialize(:int32, Map.fetch!(struct, :session_epoch)),
          case Map.fetch!(struct, :topics) do
            nil ->
              <<-1::32-signed>>
          ...
          case Map.fetch!(struct, :forgotten_topics_data) do
            nil ->
              <<-1::32-signed>>
            ...
            topics: [
              %{
                ...
                partitions: [
                  %{
                    partition: nil | integer(),
                    current_leader_epoch: nil | integer(),
                    fetch_offset: nil | integer(),
                    log_start_offset: nil | integer(),
                    partition_max_bytes: nil | integer()
                  }
                      ...
                      vals when is_list(vals) ->
                        [
                          ...
                          for v <- vals do
                            [
                              serialize(:int32, Map.fetch!(v, :partition)),
                              serialize(:int32, Map.fetch!(v, :current_leader_epoch)),
                              serialize(:int64, Map.fetch!(v, :fetch_offset)),
                              serialize(:int64, Map.fetch!(v, :log_start_offset)),
                              serialize(:int32, Map.fetch!(v, :partition_max_bytes))
                            ]
...
"
    ...
    @doc "Returns a function that can be used to deserialize the wire response from the\nbroker for this message type\n"
    @spec response_deserializer :: (binary -> {V10.Response.t(), binary})
    def response_deserializer do
      &V10.Response.deserialize/1
    end
  ...
  defimpl(Elixir.Kayrock.Request, for: V10.Request) do
    def serialize(%V10.Request{} = struct) do
      try do
        V10.Request.serialize(struct)
      rescue
        e -> reraise Kayrock.InvalidRequestError, {e, struct}, __STACKTRACE__
      end
    end

    def api_vsn(%V10.Request{}) do
      V10.Request.api_vsn()
    end

    def response_deserializer(%V10.Request{}) do
      V10.Request.response_deserializer()
    end
  end

  defmodule V11.Request do
    @vsn 11
    @api :fetch
    @schema replica_id: :int32,
            max_wait_time: :int32,
...
"
    ...
    @doc "Returns a function that can be used to deserialize the wire response from the\nbroker for this message type\n"
    @spec response_deserializer :: (binary -> {V11.Response.t(), binary})
    def response_deserializer do
      &V11.Response.deserialize/1
    end
    ...
    def serialize(%V11.Request{} = struct) do
      [
        ...
        [
          ...
          serialize(:string, Map.fetch!(struct, :rack_id))
        ]
      ]
    end
  end

  defimpl(Elixir.Kayrock.Request, for: V11.Request) do
    def serialize(%V11.Request{} = struct) do
      try do
        V11.Request.serialize(struct)
      rescue
        e -> reraise Kayrock.InvalidRequestError, {e, struct}, __STACKTRACE__
      end
    end

    def api_vsn(%V11.Request{}) do
      V11.Request.api_vsn()
    end

    def response_deserializer(%V11.Request{}) do
      V11.Request.response_deserializer()
    end
  end
  ...
  def get_request_struct(10) do
    %V10.Request{}
  end

  def get_request_struct(11) do
    %V11.Request{}
  end
...
"
                ...
                partition_responses: [
                  %{
                    partition_header: %{
                      ...
                      preferred_read_replica: nil | integer()
                    },
                    record_set: nil | Kayrock.MessageSet.t() | Kayrock.RecordBatch.t()
                  }
                ]
    ...
    defp deserialize_field(:partition_header, :preferred_read_replica, acc, data) do
      {val, rest} = deserialize(:int32, data)
      deserialize_field(:partition_header, nil, Map.put(acc, :preferred_read_replica, val), rest)
    end
  ...
  def deserialize(10, data) do
    V10.Response.deserialize(data)
  end

  def deserialize(11, data) do
    V11.Response.deserialize(data)
  end

  (
    @typedoc "Union type for all request structs for this API"
    @type request_t ::
            Kayrock.Fetch.V11.Request.t()
            | Kayrock.Fetch.V10.Request.t()
            | Kayrock.Fetch.V9.Request.t()
            | Kayrock.Fetch.V8.Request.t()
  ...
  (
    ...
    @type response_t ::
            Kayrock.Fetch.V11.Response.t()
            | Kayrock.Fetch.V10.Response.t()
            | Kayrock.Fetch.V9.Response.t()
            | Kayrock.Fetch.V8.Response.t()
