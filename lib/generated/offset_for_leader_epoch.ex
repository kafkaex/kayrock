defmodule Kayrock.OffsetForLeaderEpoch do
  @api :offset_for_leader_epoch
...
"
    @type t :: %__MODULE__{
            topics: [
              %{
                topic: nil | binary(),
                partitions: [%{partition: nil | integer(), leader_epoch: nil | integer()}]
              }
            ],
    ...
    def api_key do
      Kayrock.KafkaSchemaMetadata.api_key(:offset_for_leader_epoch)
    end
                        ...
                        [
                          ...
                          for v <- vals do
                            [
                              ...
                              serialize(:int32, Map.fetch!(v, :leader_epoch))
                            ]
                          end
                        ]
                    end
...
"
    ...
    defp deserialize_field(:partitions, :error_code, acc, data) do
      ...
      deserialize_field(:partitions, :partition, Map.put(acc, :error_code, val), rest)
    end

    defp deserialize_field(:partitions, :partition, acc, data) do
      {val, rest} = deserialize(:int32, data)
      deserialize_field(:partitions, :end_offset, Map.put(acc, :partition, val), rest)
    end

    defp deserialize_field(:partitions, :end_offset, acc, data) do
      {val, rest} = deserialize(:int64, data)
      deserialize_field(:partitions, nil, Map.put(acc, :end_offset, val), rest)
    end
...
"
    ...
    defp deserialize_field(:partitions, :partition, acc, data) do
      {val, rest} = deserialize(:int32, data)
      deserialize_field(:partitions, :leader_epoch, Map.put(acc, :partition, val), rest)
    end

    defp deserialize_field(:partitions, :leader_epoch, acc, data) do
      {val, rest} = deserialize(:int32, data)
      deserialize_field(:partitions, :end_offset, Map.put(acc, :leader_epoch, val), rest)
    end
...
"
  ...
  (
    ...
    @type request_t ::
            Kayrock.OffsetForLeaderEpoch.V3.Request.t()
            | Kayrock.OffsetForLeaderEpoch.V2.Request.t()
            | Kayrock.OffsetForLeaderEpoch.V1.Request.t()
            | Kayrock.OffsetForLeaderEpoch.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.OffsetForLeaderEpoch.V3.Response.t()
            | Kayrock.OffsetForLeaderEpoch.V2.Response.t()
            | Kayrock.OffsetForLeaderEpoch.V1.Response.t()
            | Kayrock.OffsetForLeaderEpoch.V0.Response.t()
  )
