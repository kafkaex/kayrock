...
"
  ...
  defmodule V0.Request do
    @vsn 0
    @api :expire_delegation_token
    @schema hmac: :bytes, expiry_time_period_ms: :int64
...
"
    _ = " THIS CODE IS GENERATED BY KAYROCK"
    defstruct hmac: nil, expiry_time_period_ms: nil, correlation_id: nil, client_id: nil
    import Elixir.Kayrock.Serialize
    @typedoc "Request struct for the Kafka `#{@api}` API v#{@vsn}
"
    @type t :: %__MODULE__{
            hmac: nil | bitstring(),
            expiry_time_period_ms: nil | integer(),
...
"
  ...
  defmodule V0.Response do
    @vsn 0
    @api :expire_delegation_token
    @schema error_code: :int16, expiry_timestamp_ms: :int64, throttle_time_ms: :int32
...
"
    ...
    defp deserialize_field(:root, :error_code, acc, data) do
      ...
      deserialize_field(:root, :expiry_timestamp_ms, Map.put(acc, :error_code, val), rest)
    end

    defp deserialize_field(:root, :expiry_timestamp_ms, acc, data) do
      {val, rest} = deserialize(:int64, data)
      deserialize_field(:root, :throttle_time_ms, Map.put(acc, :expiry_timestamp_ms, val), rest)
    end
...
"
  ...
  (
    ...
    @type request_t ::
            Kayrock.ExpireDelegationToken.V1.Request.t()
            | Kayrock.ExpireDelegationToken.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.ExpireDelegationToken.V1.Response.t()
            | Kayrock.ExpireDelegationToken.V0.Response.t()
  )
