...
"
  ...
  (
    ...
    @type request_t ::
            Kayrock.CreatePartitions.V1.Request.t() | Kayrock.CreatePartitions.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.CreatePartitions.V1.Response.t() | Kayrock.CreatePartitions.V0.Response.t()
  )
