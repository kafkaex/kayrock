            ...
            topics:
              {:array,
               [
                 topic: :string,
                 partitions:
                   {:array, [partition: :int32, offset: :int64, metadata: :nullable_string]}
               ]}
    ...
    @type t :: %__MODULE__{
            ...
            topics: [
              %{
                topic: nil | binary(),
                partitions: [
                  %{partition: nil | integer(), offset: nil | integer(), metadata: nil | binary()}
                ]
              }
            ],
  ...
  defmodule(V0.Response) do
    ...
    @type t :: %__MODULE__{
            responses: [
              %{
                topic: nil | binary(),
                partition_responses: [%{partition: nil | integer(), error_code: nil | integer()}]
              }
            ],
