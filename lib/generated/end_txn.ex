...
"
    @type t :: %__MODULE__{
            ...
            transaction_result: nil | integer(),
...
"
  ...
  (
    ...
    @type request_t :: Kayrock.EndTxn.V1.Request.t() | Kayrock.EndTxn.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t :: Kayrock.EndTxn.V1.Response.t() | Kayrock.EndTxn.V0.Response.t()
  )
