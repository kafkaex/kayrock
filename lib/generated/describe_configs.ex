    ...
    @type t :: %__MODULE__{
            ...
            resources: [
              %{
                ...
                config_entries: [
                  %{
                    config_name: nil | binary(),
                    config_value: nil | binary(),
                    read_only: nil | integer(),
                    is_default: nil | integer(),
...
"
  ...
  (
    ...
    @type request_t ::
            Kayrock.DescribeConfigs.V2.Request.t()
            | Kayrock.DescribeConfigs.V1.Request.t()
            | Kayrock.DescribeConfigs.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.DescribeConfigs.V2.Response.t()
            | Kayrock.DescribeConfigs.V1.Response.t()
            | Kayrock.DescribeConfigs.V0.Response.t()
  )
