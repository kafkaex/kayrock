...
"
  ...
  (
    ...
    @type request_t :: Kayrock.DeleteRecords.V1.Request.t() | Kayrock.DeleteRecords.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.DeleteRecords.V1.Response.t() | Kayrock.DeleteRecords.V0.Response.t()
  )
