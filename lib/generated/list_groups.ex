...
"
  ...
  defmodule V3.Request do
    @vsn 3
    @api :list_groups
    @schema tagged_fields: :tagged_fields
    @moduledoc "Kayrock-generated request struct for Kafka `#{@api}` v#{@vsn} API
messages
...
"
    _ = " THIS CODE IS GENERATED BY KAYROCK"
    defstruct tagged_fields: [], correlation_id: nil, client_id: nil
...
"
    ...
    defp deserialize_field(:groups, :protocol_type, acc, data) do
      {val, rest} = deserialize(:compact_string, data)
      deserialize_field(:groups, :tagged_fields, Map.put(acc, :protocol_type, val), rest)
    end
  ...
  (
    ...
    @type request_t ::
            Kayrock.ListGroups.V3.Request.t()
            | Kayrock.ListGroups.V2.Request.t()
            | Kayrock.ListGroups.V1.Request.t()
            | Kayrock.ListGroups.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.ListGroups.V3.Response.t()
            | Kayrock.ListGroups.V2.Response.t()
            | Kayrock.ListGroups.V1.Response.t()
            | Kayrock.ListGroups.V0.Response.t()
  )
