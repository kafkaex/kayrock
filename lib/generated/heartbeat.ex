...
"
  ...
  defmodule V4.Response do
    @vsn 4
    @api :heartbeat
    @schema throttle_time_ms: :int32, error_code: :int16, tagged_fields: :tagged_fields
    @moduledoc "Kayrock-generated response struct for Kafka `#{@api}` v#{@vsn} API
messages
...
"
    _ = " THIS CODE IS GENERATED BY KAYROCK"
    defstruct throttle_time_ms: nil, error_code: nil, tagged_fields: [], correlation_id: nil
    @typedoc "Response struct for the Kafka `#{@api}` API v#{@vsn}
"
    @type t :: %__MODULE__{
            throttle_time_ms: nil | integer(),
  ...
  (
    ...
    @type request_t ::
            Kayrock.Heartbeat.V4.Request.t()
            | Kayrock.Heartbeat.V3.Request.t()
            | Kayrock.Heartbeat.V2.Request.t()
            | Kayrock.Heartbeat.V1.Request.t()
            | Kayrock.Heartbeat.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.Heartbeat.V4.Response.t()
            | Kayrock.Heartbeat.V3.Response.t()
            | Kayrock.Heartbeat.V2.Response.t()
            | Kayrock.Heartbeat.V1.Response.t()
            | Kayrock.Heartbeat.V0.Response.t()
  )
