...
"
    @type t :: %__MODULE__{
            ...
            topics: [
              %{
                topic: nil | binary(),
                partitions: [%{partition: nil | integer(), error_code: nil | integer()}]
              }
            ],
...
"
  ...
  (
    ...
    @type request_t ::
            Kayrock.AlterReplicaLogDirs.V1.Request.t()
            | Kayrock.AlterReplicaLogDirs.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.AlterReplicaLogDirs.V1.Response.t()
            | Kayrock.AlterReplicaLogDirs.V0.Response.t()
  )
