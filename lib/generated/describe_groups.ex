...
"
  ...
  defmodule V3.Request do
    @vsn 3
    @api :describe_groups
    @schema groups: {:array, :string}, include_authorized_operations: :boolean
    @moduledoc "Kayrock-generated request struct for Kafka `#{@api}` v#{@vsn} API
messages
...
"
    _ = " THIS CODE IS GENERATED BY KAYROCK"
    defstruct groups: [], include_authorized_operations: nil, correlation_id: nil, client_id: nil
    import Elixir.Kayrock.Serialize
    @typedoc "Request struct for the Kafka `#{@api}` API v#{@vsn}
"
    @type t :: %__MODULE__{
            groups: [nil | binary()],
            include_authorized_operations: nil | integer(),
            correlation_id: nil | integer(),
            client_id: nil | binary()
          }
    @doc "Returns the Kafka API key for this API"
...
"
  ...
  defmodule V5.Request do
    @vsn 5
    @api :describe_groups
    @schema groups: {:compact_array, :compact_string},
...
"
    @type t :: %__MODULE__{
            groups: [
              %{
                ...
                group_id: nil | binary(),
                group_state: nil | binary(),
                protocol_type: nil | binary(),
                protocol_data: nil | binary(),
                members: [
                  %{
    ...
    defp deserialize_field(:groups, :group_id, acc, data) do
      ...
      deserialize_field(:groups, :group_state, Map.put(acc, :group_id, val), rest)
    end

    defp deserialize_field(:groups, :group_state, acc, data) do
      {val, rest} = deserialize(:string, data)
      deserialize_field(:groups, :protocol_type, Map.put(acc, :group_state, val), rest)
    end

    defp deserialize_field(:groups, :protocol_type, acc, data) do
      {val, rest} = deserialize(:string, data)
      deserialize_field(:groups, :protocol_data, Map.put(acc, :protocol_type, val), rest)
    end

    defp deserialize_field(:groups, :protocol_data, acc, data) do
      {val, rest} = deserialize(:string, data)
      deserialize_field(:groups, :members, Map.put(acc, :protocol_data, val), rest)
    end
...
"
    @type t :: %__MODULE__{
            ...
            groups: [
              %{
                ...
                authorized_operations: nil | integer()
              }
            ],
            correlation_id: integer()
          }
    ...
    defp deserialize_field(:groups, :members, acc, data) do
      ...
      deserialize_field(
        ...
        Map.put(acc, :members, Enum.reverse(vals)),
        rest
      )
    end

    defp deserialize_field(:groups, :authorized_operations, acc, data) do
      {val, rest} = deserialize(:int32, data)
      deserialize_field(:groups, nil, Map.put(acc, :authorized_operations, val), rest)
    end
...
"
    ...
    defp deserialize_field(:members, :group_instance_id, acc, data) do
      ...
      deserialize_field(:members, :client_id, Map.put(acc, :group_instance_id, val), rest)
    end
...
"
    _ = " THIS CODE IS GENERATED BY KAYROCK"
    defstruct throttle_time_ms: nil, groups: [], tagged_fields: [], correlation_id: nil
    @typedoc "Response struct for the Kafka `#{@api}` API v#{@vsn}
"
    @type t :: %__MODULE__{
            throttle_time_ms: nil | integer(),
                    ...
                    members:
                      ...
                      | [
                          %{
                            ...
                            client_id: nil | binary(),
                            client_host: nil | binary(),
                            member_metadata: nil | binary(),
                            member_assignment: nil | binary(),
                            tagged_fields: [{non_neg_integer(), binary()}]
                          }
                        ],
                    authorized_operations: nil | integer(),
    ...
    defp deserialize_field(:members, :member_assignment, acc, data) do
      {val, rest} = deserialize(:compact_bytes, data)
      deserialize_field(:members, :tagged_fields, Map.put(acc, :member_assignment, val), rest)
    end
    ...
    defp deserialize_field(:groups, :members, acc, data) do
      ...
      deserialize_field(:groups, :authorized_operations, Map.put(acc, :members, final_vals), rest)
    end

    defp deserialize_field(:groups, :authorized_operations, acc, data) do
      {val, rest} = deserialize(:int32, data)
      deserialize_field(:groups, :tagged_fields, Map.put(acc, :authorized_operations, val), rest)
    end

    defp deserialize_field(:groups, :tagged_fields, acc, data) do
      {val, rest} = Kayrock.Deserialize.deserialize_tagged_fields(data)
      deserialize_field(:groups, nil, Map.put(acc, :tagged_fields, val), rest)
    end
    ...
    defp deserialize_field(:root, :groups, acc, data) do
      ...
      deserialize_field(:root, :tagged_fields, Map.put(acc, :groups, final_vals), rest)
    end
  ...
  (
    ...
    @type request_t ::
            Kayrock.DescribeGroups.V5.Request.t()
            | Kayrock.DescribeGroups.V4.Request.t()
            | Kayrock.DescribeGroups.V3.Request.t()
            | Kayrock.DescribeGroups.V2.Request.t()
            | Kayrock.DescribeGroups.V1.Request.t()
            | Kayrock.DescribeGroups.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.DescribeGroups.V5.Response.t()
            | Kayrock.DescribeGroups.V4.Response.t()
            | Kayrock.DescribeGroups.V3.Response.t()
            | Kayrock.DescribeGroups.V2.Response.t()
            | Kayrock.DescribeGroups.V1.Response.t()
            | Kayrock.DescribeGroups.V0.Response.t()
  )
