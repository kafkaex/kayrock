defmodule Kayrock.OffsetDelete do
  @api :offset_delete
...
"
    @type t :: %__MODULE__{
            group_id: nil | binary(),
            topics: [%{name: nil | binary(), partitions: [%{partition_index: nil | integer()}]}],
    ...
    def api_key do
      Kayrock.KafkaSchemaMetadata.api_key(:offset_delete)
    end
...
"
    _ = " THIS CODE IS GENERATED BY KAYROCK"
    defstruct error_code: nil, throttle_time_ms: nil, topics: [], correlation_id: nil
...
"
    ...
    defp deserialize_field(:root, :error_code, acc, data) do
      ...
      deserialize_field(:root, :throttle_time_ms, Map.put(acc, :error_code, val), rest)
    end
  ...
  (
    ...
    @type request_t :: Kayrock.OffsetDelete.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t :: Kayrock.OffsetDelete.V0.Response.t()
  )
