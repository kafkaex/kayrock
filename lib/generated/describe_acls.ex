...
"
    ...
    defstruct resource_type: nil,
              resource_name: nil,
              resource_pattern_type_filter: nil,
              principal: nil,
              host: nil,
              operation: nil,
              permission_type: nil,
...
"
    @type t :: %__MODULE__{
            resource_type: nil | integer(),
            resource_name: nil | binary(),
            resource_pattern_type_filter: nil | integer(),
            principal: nil | binary(),
            host: nil | binary(),
            operation: nil | integer(),
            permission_type: nil | integer(),
    ...
    def serialize(%V1.Request{} = struct) do
      [
        ...
        [
          serialize(:int8, Map.fetch!(struct, :resource_type)),
          serialize(:nullable_string, Map.fetch!(struct, :resource_name)),
          serialize(:int8, Map.fetch!(struct, :resource_pattern_type_filter)),
          serialize(:nullable_string, Map.fetch!(struct, :principal)),
          serialize(:nullable_string, Map.fetch!(struct, :host)),
          serialize(:int8, Map.fetch!(struct, :operation)),
          serialize(:int8, Map.fetch!(struct, :permission_type))
...
"
    @type t :: %__MODULE__{
            ...
            resources: [
              %{
                resource_type: nil | integer(),
                resource_name: nil | binary(),
                resource_pattern_type: nil | integer(),
                acls: [
                  %{
                    principal: nil | binary(),
                    host: nil | binary(),
    ...
    defp deserialize_field(:resources, :resource_name, acc, data) do
      ...
      deserialize_field(
        ...
        Map.put(acc, :resource_name, val),
        rest
      )
    end

    defp deserialize_field(:resources, :resource_pattern_type, acc, data) do
      {val, rest} = deserialize(:int8, data)
      deserialize_field(:resources, :acls, Map.put(acc, :resource_pattern_type, val), rest)
    end
  ...
  (
    ...
    @type request_t :: Kayrock.DescribeAcls.V1.Request.t() | Kayrock.DescribeAcls.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.DescribeAcls.V1.Response.t() | Kayrock.DescribeAcls.V0.Response.t()
  )
