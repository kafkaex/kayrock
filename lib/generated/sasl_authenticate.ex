...
"
    _ = " THIS CODE IS GENERATED BY KAYROCK"
    defstruct auth_bytes: nil, correlation_id: nil, client_id: nil
    import Elixir.Kayrock.Serialize
    @typedoc "Request struct for the Kafka `#{@api}` API v#{@vsn}
"
    @type t :: %__MODULE__{
            auth_bytes: nil | bitstring(),
...
"
  ...
  defmodule V0.Response do
    @vsn 0
    @api :sasl_authenticate
    @schema error_code: :int16, error_message: :nullable_string, auth_bytes: :bytes
...
"
    _ = " THIS CODE IS GENERATED BY KAYROCK"
    defstruct error_code: nil, error_message: nil, auth_bytes: nil, correlation_id: nil
...
"
    ...
    defp deserialize_field(:root, :error_message, acc, data) do
      ...
      deserialize_field(:root, :auth_bytes, Map.put(acc, :error_message, val), rest)
    end

    defp deserialize_field(:root, :auth_bytes, acc, data) do
      {val, rest} = deserialize(:bytes, data)
      deserialize_field(:root, nil, Map.put(acc, :auth_bytes, val), rest)
    end
...
"
    @type t :: %__MODULE__{
            ...
            error_message: nil | binary(),
            auth_bytes: nil | bitstring(),
            session_lifetime_ms: nil | integer(),
            correlation_id: integer()
          }
    import Elixir.Kayrock.Deserialize
    @doc "Returns the Kafka API key for this API"
    ...
    defp deserialize_field(:root, :auth_bytes, acc, data) do
      {val, rest} = deserialize(:bytes, data)
      deserialize_field(:root, :session_lifetime_ms, Map.put(acc, :auth_bytes, val), rest)
    end

    defp deserialize_field(:root, :session_lifetime_ms, acc, data) do
      {val, rest} = deserialize(:int64, data)
      deserialize_field(:root, nil, Map.put(acc, :session_lifetime_ms, val), rest)
    end
  ...
  (
    ...
    @type request_t ::
            Kayrock.SaslAuthenticate.V1.Request.t() | Kayrock.SaslAuthenticate.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.SaslAuthenticate.V1.Response.t() | Kayrock.SaslAuthenticate.V0.Response.t()
  )
