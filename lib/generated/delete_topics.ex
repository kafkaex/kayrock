defmodule(Kayrock.DeleteTopics) do
  ...
  defmodule(V0.Request) do
    @vsn 0
    @api :delete_topics
    @schema topics: {:array, :string}, timeout: :int32
  ...
  defmodule(V0.Response) do
    @vsn 0
    @api :delete_topics
    @schema topic_error_codes: {:array, [topic: :string, error_code: :int16]}
    ...
    @type t :: %__MODULE__{
            topic_error_codes: [%{topic: nil | binary(), error_code: nil | integer()}],
  ...
  (
    ...
    @type response_t ::
            Kayrock.DeleteTopics.V1.Response.t() | Kayrock.DeleteTopics.V0.Response.t()
  )
