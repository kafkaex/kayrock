...
"
    _ = " THIS CODE IS GENERATED BY KAYROCK"
    defstruct topic_names: [], timeout_ms: nil, correlation_id: nil, client_id: nil
    import Elixir.Kayrock.Serialize
    @typedoc "Request struct for the Kafka `#{@api}` API v#{@vsn}
"
    @type t :: %__MODULE__{
            topic_names: [nil | binary()],
...
"
  ...
  defmodule V4.Request do
    @vsn 4
    @api :delete_topics
    @schema topic_names: {:compact_array, :compact_string},
            timeout_ms: :int32,
...
"
  ...
  defmodule V0.Response do
    @vsn 0
    @api :delete_topics
    @schema responses: {:array, name: :string, error_code: :int16}
...
"
    @type t :: %__MODULE__{
            responses: [%{name: nil | binary(), error_code: nil | integer()}],
    ...
    defp deserialize_field(:responses, :name, acc, data) do
      {val, rest} = deserialize(:string, data)
      deserialize_field(:responses, :error_code, Map.put(acc, :name, val), rest)
    end

    defp deserialize_field(:responses, :error_code, acc, data) do
      {val, rest} = deserialize(:int16, data)
      deserialize_field(:responses, nil, Map.put(acc, :error_code, val), rest)
    end
      ...
      {vals, rest} =
        if num_elements > 0 do
          Enum.reduce(1..num_elements, {[], rest}, fn _ix, {acc, d} ->
            {val, r} = deserialize_field(:responses, :name, %{}, d)
            {[val | acc], r}
          end)
        else
          {[], rest}
  ...
  defmodule V1.Response do
    @vsn 1
    @api :delete_topics
    @schema throttle_time_ms: :int32, responses: {:array, name: :string, error_code: :int16}
    @moduledoc "Kayrock-generated response struct for Kafka `#{@api}` v#{@vsn} API
messages
...
"
    ...
    defp deserialize_field(:responses, :error_code, acc, data) do
      {val, rest} = deserialize(:int16, data)
      deserialize_field(:responses, :tagged_fields, Map.put(acc, :error_code, val), rest)
    end
  ...
  (
    ...
    @type request_t ::
            Kayrock.DeleteTopics.V4.Request.t()
            | Kayrock.DeleteTopics.V3.Request.t()
            | Kayrock.DeleteTopics.V2.Request.t()
            | Kayrock.DeleteTopics.V1.Request.t()
            | Kayrock.DeleteTopics.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.DeleteTopics.V4.Response.t()
            | Kayrock.DeleteTopics.V3.Response.t()
            | Kayrock.DeleteTopics.V2.Response.t()
            | Kayrock.DeleteTopics.V1.Response.t()
            | Kayrock.DeleteTopics.V0.Response.t()
  )
