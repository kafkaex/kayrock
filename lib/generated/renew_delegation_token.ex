...
"
  ...
  defmodule V0.Request do
    @vsn 0
    @api :renew_delegation_token
    @schema hmac: :bytes, renew_period_ms: :int64
...
"
    _ = " THIS CODE IS GENERATED BY KAYROCK"
    defstruct hmac: nil, renew_period_ms: nil, correlation_id: nil, client_id: nil
    import Elixir.Kayrock.Serialize
    @typedoc "Request struct for the Kafka `#{@api}` API v#{@vsn}
"
    @type t :: %__MODULE__{
            hmac: nil | bitstring(),
            renew_period_ms: nil | integer(),
...
"
  ...
  (
    ...
    @type request_t ::
            Kayrock.RenewDelegationToken.V1.Request.t()
            | Kayrock.RenewDelegationToken.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.RenewDelegationToken.V1.Response.t()
            | Kayrock.RenewDelegationToken.V0.Response.t()
  )
