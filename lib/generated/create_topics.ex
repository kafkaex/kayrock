defmodule(Kayrock.CreateTopics) do
    ...
    @type t :: %__MODULE__{
            create_topic_requests: [
              %{
                ...
                replica_assignment: [%{partition: nil | integer(), replicas: [nil | integer()]}],
  ...
  defmodule(V0.Response) do
    @vsn 0
    @api :create_topics
    @schema topic_errors: {:array, [topic: :string, error_code: :int16]}
    ...
    @type t :: %__MODULE__{
            topic_errors: [%{topic: nil | binary(), error_code: nil | integer()}],
