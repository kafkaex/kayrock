    ...
    @type t :: %__MODULE__{
            resources: [
              %{
                ...
                config_entries: [%{config_name: nil | binary(), config_value: nil | binary()}]
              }
            ],
...
"
  ...
  (
    ...
    @type request_t :: Kayrock.AlterConfigs.V1.Request.t() | Kayrock.AlterConfigs.V0.Request.t()
  )

  (
    @typedoc "Union type for all response structs for this API"
    @type response_t ::
            Kayrock.AlterConfigs.V1.Response.t() | Kayrock.AlterConfigs.V0.Response.t()
  )
