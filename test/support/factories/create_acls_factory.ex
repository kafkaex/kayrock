defmodule Kayrock.Test.Factories.CreateAclsFactory do
  @moduledoc """
  Factory for CreateAcls API test data (V0-V1).
  ...
  def request_data(0) do
    request = %Kayrock.CreateAcls.V0.Request{
      correlation_id: 0,
      client_id: "test",
      creations: [
        %{
  ...
  def request_data(1) do
    request = %Kayrock.CreateAcls.V1.Request{
      correlation_id: 1,
      client_id: "test",
      creations: [
        %{
    ...
    expected_binary = <<
      ...
      6,
      "topic1"::binary,
      # resource_pattern_type (3 = PREFIXED)
      3,
      # principal
      0,
      8,
  ...
  def response_data(0) do
    binary = <<
      ...
      0,
      0,
      # creation_responses array length
      0,
      0,
      0,
      1,
    ...
    expected_struct = %Kayrock.CreateAcls.V0.Response{
      correlation_id: 0,
      throttle_time_ms: 0,
      creation_responses: [
        %{error_code: 0, error_message: nil}
      ]
    }
  ...
  def response_data(1) do
    ...
    expected_struct = %Kayrock.CreateAcls.V1.Response{
      correlation_id: 1,
      throttle_time_ms: 50,
      creation_responses: [
        %{error_code: 0, error_message: nil}
  ...
  def error_response(0, opts) do
    ...
    error_message = "ACL creation failed"
