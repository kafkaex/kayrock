defmodule Kayrock.ListPartitionReassignmentsTest do
  @moduledoc """
  Tests for ListPartitionReassignments API (V0).
  ...
  describe "versions compatibility" do
    test "serializes version 0 request to expected binary" do
      {request, expected_binary} = ListPartitionReassignmentsFactory.request_data(0)
  ...
  describe "V0 - basic list partition reassignments" do
    ...
    test "response deserializes correctly" do
      {response_binary, expected} = ListPartitionReassignmentsFactory.response_data(0)
      ...
      assert partition.replicas == [0, 1, 2]
      assert partition.adding_replicas == [3]
      assert partition.removing_replicas == [0]
    end
  end
